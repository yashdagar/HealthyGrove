...
import com.sdgwarriors.healthygrove.R
import androidx.compose.material.Typography as TypographyOld

val LobsterTwo = FontFamily(
    Font(R.font.lobstertwo, FontWeight.Normal)
)
